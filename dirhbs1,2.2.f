...
C------------------
               ...
               do n = 1,nf
                  sf = sf + fgcan(n+(k-1)*nh,mf,4)*rnl2(n,1)
C------------------
                  snf = snf + fgcan(n+(k-1)*nh,mf,4)*
     &            fgcan(n+(k-1)*nh,mf,4)
                  if (imc.eq.0 .and. iplot.eq.1) then
                  write(l6,'(f15.6)') fgcan(n+(k-1)*nh,mf,1)
                  end if
C------------------
               enddo
               if (imc.eq.0 .and. iplot.eq.1) then
               ...
               do n = 1,ng
                  sg = sg + fgcan(nf+n+(k-1)*nh,mf,4)*rnl2(n,2)
C------------------
cll         sng = sng + fg(nf+n+(k-1)*nd,mf)*rnl(n,2)
                   sng = sng + fgcan(nf+n+(k-1)*nh,mf,4)*
     &                  fgcan(nf+n+(k-1)*nh,mf,4)
                   if (imc.eq.0 .and. iplot.eq.1) then
...
c======================================================================c
      ...
      subroutine rwave(it,ib,k,r,f,g,ih)
...
C------------------
      ...
      do n = 1,nf
         sf = sf + fgcan(n+(k-1)*nd,mf,4)*rnl2(n,1)
C------------------
         snf = snf + fgcan(n+(k-1)*nd,mf,4)*fgcan(n+(k-1)*nd,mf,4)
         if (imc.eq.0 .and. iplot.eq.1) then
         write(l6,'(f15.6)') fgcan(n+(k-1)*nd,mf,1)
         end if
C------------------
      enddo
      if (imc.eq.0 .and. iplot.eq.1) then
      ...
      do n = 1,ng
         sg = sg + fgcan(nf+n+(k-1)*nd,mf,4)*rnl2(n,2)
C------------------
cll         sng = sng + fg(nf+n+(k-1)*nd,mf)*rnl(n,2)
         sng = sng + fgcan(nf+n+(k-1)*nd,mf,4)*fgcan(nf+n+(k-1)*nd,mf,4)
         if (imc.eq.0 .and. iplot.eq.1) then
            !write(l6,'(f15.6)') fg(nf+n+(k-1)*nd,mf,4)
         end if
C------------------
